      ...
      steps: [
        {
          ...
          description: 'Android has a built-in way to use custom DNS. We just need to turn it on.',
          difficulty: 'Easy',
          time: 1,
          instructions: [
            'Open <strong>Settings</strong> on your phone.',
            'Tap <strong>Network & internet</strong>.',
            'Tap <strong>Private DNS</strong> (may also be under "Advanced").',
            'Select <strong>Private DNS provider hostname</strong>.',
          ],
          tip: 'This works on Android 9 and newer.',
          devices: [
        ...
        {
          title: 'Enter Your DNS Address',
          description: 'Copy the address below and paste it into the hostname field.',
          difficulty: 'Easy',
          time: 1,
          dnsAddress: ep.dot,
          instructions: [
            'Tap the hostname field.',
            'Copy the <strong>blue address</strong> above and paste it here.',
            'Tap <strong>Save</strong>.',
            'That\'s it! Your phone is now protected on all networks.',
          ],
          tip: 'This works on both Wi-Fi and mobile data. No app needed!',
